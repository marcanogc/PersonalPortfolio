  ...
  try {
    ...
    const projectsData = [
      ...
      },
      {
        ...
        description_pt: "Dashboards executivos com alertas em tempo real em diversas áreas: Logística, Controle de Estoque, Controle Financeiro, Comercial, Orçamentário, Gestão de Vendas e Fluxo de Caixa. Insight chave: 70% de melhoria na eficiência operacional. Impacto: 25% redução nos custos operacionais.",
        category: "Business Intelligence",
